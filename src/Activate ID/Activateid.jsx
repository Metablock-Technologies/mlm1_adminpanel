                                            ...
                                            {/* <div className="form-row">
                                                <div className="col-md-12 mb-3">
                                                    ...
                                                    <div className="input-group">
                                                        <input type="text" className="form-control input_box" defaultValue={0.00} id="validationCustomUsername" placeholder="Available Balance" aria-describedby="inputGroupPrepend" required disabled />
                                                    </div>
                                                </div>
