    ...
    return (
        <>
            ...
            >
                ...
                {/* <Collapse in={open} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => navigate('activateidhistory')} sx={{ pl: 4 }}>
                            <ListItemIcon>
                                <PeopleIcon sx={{ marginLeft: '-11px', color: 'white' }} />
                            </ListItemIcon>
                            <ListItemText primary="ActivateID Transfer History" />
                        </ListItemButton>
                    </List>
                </Collapse> */}
                <Collapse in={open} timeout="auto" unmountOnExit>
                    <List component="div" disablePadding>
                        <ListItemButton onClick={() => navigate('activateid')} sx={{ pl: 4 }}>
                            <ListItemIcon>
                                <PeopleIcon sx={{ marginLeft: '-11px', color: 'white' }} />
                            </ListItemIcon>
                            <ListItemText primary="Activate ID" />
